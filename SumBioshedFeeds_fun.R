...
# RETURNS:
# An object of class SpatialPointsDataFrame with point features representing
# refinery locations. Total biomass of available feedstocks in each refinery's 
# bioshed is stored in the @data slot of the SpatialPointsDataFrame. 
