...
#' 
#' PARAMS:
#' data -  a data frame in which each entry represents a POI. The first 
#' column contains the name of the POI and the second column contains the 
#' it's US postal address.
#' 
#' RETURNS:
#' geocoded_pois.df -  an object of class SpatialPointsDataFrame in which 
#' the @data portion consists of a df identical to the input df. 
#'

# Adapted from an instructional blog post by Shane Lynn, 10/10/2013
#-----------------------------------------------------------------------------#
